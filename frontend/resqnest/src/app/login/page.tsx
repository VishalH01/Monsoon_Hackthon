      ...
      <section className="hidden lg:flex lg:w-1/2 relative bg-[#0F172A] overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 w-full px-16 flex flex-col items-center">
          ...
          <div className="w-full max-w-2xl transform hover:scale-[1.02] transition-transform duration-700 ease-out">
            ...
            <img
              alt="ResQNest Disaster Management Ecosystem"
        ...
        <div className="w-full max-w-[440px] flex flex-col">
          ...
          <div className="bg-white rounded-xl p-8 lg:p-10 shadow-md border border-slate-200">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-outline-variant hover:bg-slate-50 rounded-lg transition-all active:scale-95 cursor-pointer">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                className="w-full py-4 bg-primary-container text-white font-label-md text-label-md rounded-lg shadow-lg shadow-primary-container/20 hover:bg-primary transition-all active:scale-[0.98] mt-4 flex items-center justify-center gap-2 group cursor-pointer"
                type="submit"
                disabled={loading}
              >
                {loading ? (
