...
export default function LandingPage() {
  ...
  useEffect(() => {
    api.stats.fetchPublicStats()
      .then((data) => {
        if (data) {
          setStats({
            avgResponse: data.avgResponse || "12 mins",
            livesImpacted: data.livesImpacted || 120,
            countries: data.countries || 1,
    ...
    <div ref={containerRef} className="bg-[#F8FAFC] text-on-surface">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            <div className="glass-card p-8 md:p-12 rounded-[16px] shadow-2xl">
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">
                ResQNest provides the mission-critical infrastructure to
          ...
          <div className="relative flex justify-center">
            ...
            <img
              alt="ResQNest Platform Visualization"
      ...
      <section className="py-16 bg-white border-y border-outline-variant/20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { value: stats.avgResponse, label: "Avg. Response", color: "text-primary" },
              { value: stats.livesImpacted.toLocaleString() + "+", label: "Lives Impacted", color: "text-secondary" },
              { value: stats.countries.toString(), label: "Countries", color: "text-on-surface" },
              { value: stats.volunteers.toLocaleString() + "+", label: "Volunteers", color: "text-on-surface" },
            ].map((stat) => (
              <div
                key={stat.label}
      ...
      <section className="py-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Testimonial
              quote="ResQNest has transformed our response time. During the last hurricane, the AI prioritization saved us hours of triage, allowing our teams to reach victims in under 15 minutes."
              name="Sarah Jenkins"
      ...
      <footer className="bg-[#0F172A] text-white py-20">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 pt-8 border-t border-white/10 text-center text-white/30 font-body-sm">
          © 2024 ResQNest Systems. All rights reserved. Precision Software for
          Humanitarian Crisis.
        </div>
      </footer>
    </div>
